...
namespace ergasiamvc.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public ActionResult RemoveFromPlaylist(int playlistid, int trackid)
        {
            db.Playlists.Find(playlistid).Tracks.Remove(db.Tracks.Find(trackid));
            db.SaveChanges();
            return RedirectToAction("Edit\\"+playlistid);
        }
